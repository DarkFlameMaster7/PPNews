package com.ppworks.ppnews.module.video.ui;
...
import com.ppworks.ppnews.module.video.presenter.IVideoListPresenter;
import com.ppworks.ppnews.module.video.presenter.IVideoListPresenterImpl;
...
public class VideoListFragment extends BaseFragment<IVideoListPresenter> implements IVideoListView {
    ...
    private BaseRecyclerAdapter<NeteaseVideoSummary> mAdapter;
    ...
    @Override
    public void updateVideoList(List<NeteaseVideoSummary> data, @DataLoadType.DataLoadTypeChecker int type) {
        switch (type) {
    ...
    private void initVideoList(List<NeteaseVideoSummary> data) {

        final StaggeredGridLayoutManager layoutManager = new StaggeredGridLayoutManager(2,
                StaggeredGridLayoutManager.VERTICAL);

        mAdapter = new BaseRecyclerAdapter<NeteaseVideoSummary>(getActivity(), data, true,
                layoutManager) {
            ...
            @Override
            public void bindData(BaseRecyclerViewHolder holder, final int position, final NeteaseVideoSummary item) {
