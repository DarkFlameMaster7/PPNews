package com.ppworks.ppnews.module.settings.ui;
...
import com.ppworks.ppnews.module.settings.presenter.ISettingsPresenter;
import com.ppworks.ppnews.module.settings.presenter.ISettingsPresenterImpl;
...
public class SettingsActivity extends BaseActivity<ISettingsPresenter>
        implements
        ISettingsView {
