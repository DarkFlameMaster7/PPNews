...
import com.ppworks.ppnews.module.news.presenter.INewsDetailPresenter;
import com.ppworks.ppnews.module.news.presenter.INewsDetailPresenterImpl;
...
public class NewsDetailActivity extends BaseActivity<INewsDetailPresenter>
    ...
    @Override
    public void initNewsDetail(NeteaseNewsDetail data) {
        if (data.img != null && data.img.size() > 0) {
            ...
            for (NeteaseNewsDetail.ImgEntity entiity : data.img) {
