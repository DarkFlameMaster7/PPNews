...
import com.ppworks.ppnews.callback.SimpleItemTouchHelperCallback;
import com.ppworks.ppnews.greendao.NewsChannelTable;
import com.ppworks.ppnews.module.news.presenter.INewsChannelPresenter;
import com.ppworks.ppnews.module.news.presenter.INewsChannelPresenterImpl;
import com.ppworks.ppnews.module.news.ui.adapter.NewsChannelAdapter;
...
import com.ppworks.ppnews.utils.TextViewUtil;
...
public class NewsChannelActivity extends BaseActivity<INewsChannelPresenter>
    ...
    public void initTwoRecyclerView(List<NewsChannelTable> selectChannels, List<NewsChannelTable> unSelectChannels) {
        ...
        recyclerView1.addItemDecoration(new BaseSpacesItemDecoration(
                MeasureUtil.dip2px(this, 8)));
