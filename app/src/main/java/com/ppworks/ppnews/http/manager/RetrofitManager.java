package com.ppworks.ppnews.http.manager;

import android.support.annotation.NonNull;
import android.util.SparseArray;

import com.ppworks.ppnews.app.App;
...
import com.ppworks.ppnews.http.service.NewsService;
import com.ppworks.ppnews.utils.NetUtil;
...
public class RetrofitManager {
    ...
    //(假如请求了服务器并在a时刻返回响应结果，则在max-age规定的秒数内，浏览器将不会发送对应的
    // 请求到服务器，数据由缓存直接返回)时则不会使用缓存而请求服务器
     ...
     * @return 被观察对象
     */
    public Observable<Map<String, List<NeteaseNewsSummary>>> getNewsListObservable(String type, String id, int
            startPage) {
     ...
     * @return 被观察对象
     */
    public Observable<Map<String, NeteaseNewsDetail>> getNewsDetailObservable(String postId) {
        return mNewsService.getNewsDetail(getCacheControl(), postId).subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread()).unsubscribeOn(Schedulers.io());
    }

    /**
     * 新浪图片新闻列表 例子：http://api.sina.cn/sinago/list
     * .json?channel=hdpic_pretty&adid=4ad30dabe134695c3b7c3a65977d7e72&wm=b207&from=6042095012&chwm=12050_0001
     * &oldchwm=12050_0001&imei=867064013906290&uid=802909da86d9f5fc&p=1
     *
     * @param page 页码
     * @return 被观察对象
     */
    ...
    /**
     * 新浪图片详情 例子：http://api.sina.cn/sinago/article
     * .json?postt=hdpic_hdpic_toutiao_4&wm=b207&from=6042095012&chwm=12050_0001&oldchwm=12050_0001&imei
     * =867064013906290&uid=802909da86d9f5fc&id=20550-66955-hdpic
     *
     * @param id 图片的id
     * @return 被观察者
     */
     ...
     * @return 被观察者
     */
    public Observable<Map<String, List<NeteaseVideoSummary>>> getVideoListObservable(String id, int startPage) {
