package com.ppworks.ppnews.http.service;
...
public interface NewsService {
    ...
    Observable<Map<String, List<NeteaseNewsSummary>>> getNewsList(
    ...
    Observable<Map<String, NeteaseNewsDetail>> getNewsDetail(
            @Header("Cache-Control") String cacheControl,
     ...
     * @return 被观察对象
     */
    @GET("list.json") Observable<SinaPhotoList> getSinaPhotoList(
            @Header("Cache-Control") String cacheControl,
            ...
            @Query("uid") String uid, @Query("p") int page);
     ...
     * @return 被观察者
     */
    @GET("article.json") Observable<SinaPhotoDetail> getSinaPhotoDetail(
            @Header("Cache-Control") String cacheControl,
    ...
    Observable<Map<String, List<NeteaseVideoSummary>>> getVideoList(
            @Header("Cache-Control") String cacheControl,
            @Path("id") String id, @Path("startPage") int startPage);
